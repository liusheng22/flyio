        ...
        value: function request(url, data, options) {
            ...
            var promise = new Promise(function (resolve, reject) {
                ...
                function makeRequest(options) {
                    ...
                    // DELETE 特殊处理：默认使用query参数（符合HTTP标准），除非明确设置 deleteWithBody: true
                    if (options.method === "DELETE" && !options.deleteWithBody) {
                        needQuery = true;
                    }
                    var dataType = utils.type(data);
                    var params = options.params || {};

                    // merge url params when needQuery is true (GET/HEAD/OPTION/DELETE without deleteWithBody)
                    ...
                    // Add data to url params when needQuery is true and data is string
